...
namespace {
inline void
FillBinaryLoggingParameters(internal::WorkerProtocol_BinaryLoggerParameters& protocol_binary_params,
                            const alpha::BinaryLoggingParameters& binary_params) {
  switch (binary_params.Type) {
  case alpha::BinaryLoggingType::kNone:
    protocol_binary_params.Type = internal::WORKER_PROTOCOL_BINARY_LOGGER_TYPE_NONE;
    return;
  case alpha::BinaryLoggingType::kFile:
    protocol_binary_params.Type = internal::WORKER_PROTOCOL_BINARY_LOGGER_TYPE_FILE;
    protocol_binary_params.BinaryFile.Filename = binary_params.BinaryFile.Filename.c_str();
    protocol_binary_params.BinaryFile.MaxFileSizeBytes = binary_params.BinaryFile.MaxFileSizeBytes;
    return;
  case alpha::BinaryLoggingType::kTriggered:
    protocol_binary_params.Type = internal::WORKER_PROTOCOL_BINARY_LOGGER_TYPE_TRIGGERED;
    protocol_binary_params.BinaryTriggered.FilenamePrefix =
        binary_params.BinaryTriggered.FilenamePrefix.c_str();
    protocol_binary_params.BinaryTriggered.MillisecondsBefore =
        binary_params.BinaryTriggered.MillisecondsBefore;
    protocol_binary_params.BinaryTriggered.MillisecondsAfter =
        binary_params.BinaryTriggered.MillisecondsAfter;
    return;
  }
};
}  //  ::anonymous
...
ConvertLocatorParameters(const LocatorParameters& params) {
  ...
  protocol_params.EnableLogging = params.EnableLogging;
  protocol_params.LogPrefix = params.Logging.LogPrefix.c_str();
  protocol_params.MaxLogFiles = params.Logging.MaxLogFiles;
  protocol_params.MaxLogFileSizeBytes = params.Logging.MaxLogFileSizeBytes;
  return protocol_params;
}

inline internal::WorkerProtocol_LocatorParameters
ConvertLocatorParameters(const alpha::LocatorParameters& params) {
  internal::WorkerProtocol_LocatorParameters protocol_params = {};
  protocol_params.ProjectName = "";
  protocol_params.Flags |= internal::WORKER_PROTOCOL_LOCATOR_PLAYER_IDENTITY_CREDENTIALS;
  protocol_params.PlayerIdentity.PlayerIdentityToken =
      params.PlayerIdentity.PlayerIdentityToken.c_str();
  protocol_params.PlayerIdentity.LoginToken = params.PlayerIdentity.LoginToken.c_str();
  protocol_params.EnableLogging = params.EnableLogging;
  protocol_params.LogPrefix = params.Logging.LogPrefix.c_str();
  protocol_params.MaxLogFiles = params.Logging.MaxLogFiles;
  protocol_params.MaxLogFileSizeBytes = params.Logging.MaxLogFileSizeBytes;
  protocol_params.UseInsecureConnection = params.UseInsecureConnection;
  return protocol_params;
}

inline internal::WorkerProtocol_ConnectionParameters
ConvertConnectionParameters(const ConnectionParameters& params,
  ...
  protocol_params.Network.DefaultCommandTimeoutMillis = params.Network.DefaultCommandTimeoutMillis;
  ...
  protocol_params.Sdk.ThreadAffinity.ReceiveThreadsAffinityMask =
      params.ThreadAffinity.ReceiveThreadsAffinityMask;
  protocol_params.Sdk.ThreadAffinity.SendThreadsAffinityMask =
      params.ThreadAffinity.SendThreadsAffinityMask;
  protocol_params.Sdk.ThreadAffinity.TemporaryThreadsAffinityMask =
      params.ThreadAffinity.TemporaryThreadsAffinityMask;

  FillBinaryLoggingParameters(protocol_params.Sdk.BinaryLoggerParameters, params.BinaryLogging);
...
inline internal::WorkerProtocol_Constraint
...
inline Future<Connection> Locator::ConnectAsync(const ComponentRegistry& registry,
  ...
  auto future = WorkerProtocol_LocatorV2_ConnectAsync(locator.get(), &protocol_params);
...
inline Future<Connection> Connection::ConnectAsync(const ComponentRegistry& registry,
  ...
  auto future = detail::internal::WorkerProtocol_ConnectAsync(
      receptionist_hostname.c_str(), receptionist_port, worker_id.c_str(), &protocol_params);
